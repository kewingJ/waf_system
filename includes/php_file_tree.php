		...
		foreach( $file as $this_file ) {
			if( $this_file != "." && $this_file != ".." ) {
				if( is_dir("$directory/$this_file") ) {
					...
					$php_file_tree .= "<li class=\"pft-file " . strtolower($ext) . "\"><a href=\"#0\" class=\"btnEarchivo\" data-toggle=\"modal\" data-target=\"#ModalEArchivo\" data-ruta=\"$link\" data-nombre=\"$this_file\">" . htmlspecialchars($this_file) . "</a></li>";
				}
			}
		}
		$php_file_tree .= "</ul>";
