  ...
  var loadMyCartEvent = function(targetSelector){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<h4 class="modal-title" id="myModalLabel"><span class="glyph-icon icon-shopping-cart"></span> Mi Pedido</h4>' +
        '</div>' +
        ...
        '<button type="button" class="btn btn-primary ' + classCheckoutCart + '">Enviar</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
