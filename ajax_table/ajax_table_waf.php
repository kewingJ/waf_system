...
$columns = array(
    ...
    array( 'db' => 'id_bloqueo',   'dt' => 1,
            'formatter' => function( $d, $row ) {
				$resultado = '<img width="15px" src="img/grafica/bloqueo_waf.png" alt="">';
                return $resultado;
            } 
        ),
...
echo json_encode(
    SSP::complex( $_GET, $sql_details, $table, $primaryKey, $columns, null, "fecha_bloqueo BETWEEN '$pasado' AND '$actual'" )
);