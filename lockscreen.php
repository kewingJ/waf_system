            ...
            <div class="panel-layout wow bounceInDown">
                <div class="panel-content pad0A bg-white">
                    <div class="meta-box meta-box-offset">
                        <img src="assets/image-resources/logowaf_2022.png" alt="" class="meta-image img-bordered img-circle">
                        <h3 class="meta-heading font-size-16"><?php echo $nombre.' '.$apellido; ?></h3>
                        <h4 class="meta-subheading font-size-13 font-gray"></h4>
                    </div>
                    <form action="login.php" id="Form1" method="POST" class="form-inline block">
                        <div class="content-box-wrapper pad20A">
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="password" name="password" placeholder="Contraseña" class="form-control">
                                    <input type="hidden" name="email" value="<?php echo $correo; ?>" class="form-control">
