<?php
        ...
        if (!empty($_POST['id_credencial']) && !empty($_POST['email']))
        {
            $nombre     = 'Testing';
            $email      = $_POST['email'];
            ...
            * {
            ...
            <h1 class="v-text-align" style="margin: 0px; color: #000000; line-height: 140%; text-align: left; word-wrap: break-word; font-family: \'Cabin\',sans-serif; font-size: 31px; font-weight: 400;">Mensaje de prueba</h1>
            ...
            try 
            {
                ...
                $mail->Body = $body;
                $mail->AltBody = '';
                $mail->Subject = 'Testing de mensaje';
